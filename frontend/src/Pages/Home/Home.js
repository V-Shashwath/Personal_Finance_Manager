  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success === true) {
        ...
        handleClose();
        setRefresh(!refresh); // Trigger re-fetch of transactions
      } else {
          ...
          >
            <div className="filterRow">
              ...
              <div>
                ...
                <Button onClick={handleDeleteTransactions} className="dltMany">
                  Delete Transactions
                </Button>
            ...
            {view === "table" ? (
              <>
                <TableData data={transactions} user={cUser} refresh={refresh}
